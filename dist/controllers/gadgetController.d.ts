...
export declare const createGadget: (req: AuthRequest, res: Response) => Promise<void>;
export declare const deleteGadget: (req: AuthRequest, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const getMyGadgets: (req: AuthRequest, res: Response) => Promise<void>;
